...
####################################################################################################################
print "-----------------------------Problem-i-----------------------------------------------------------------"
"""Applying 'qr' python built-in function to get QR decomposition"""

Q,R = qr(A) 	# QR decomposition of A (a matrix from problem - a)
Qy = Q.T*Y      # suitable RHS of the system of eqn to get beta solution
...
back_substitution(R, Qy)	 	# applying back substitution function
